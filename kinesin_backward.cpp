...
const double kB=1.380649e-23; // units: N*m/K
const double vs = 23; // units: pN*nm
const double ai = 3; // units: nm
...
const double k2 = 1.0; // units: 1/s
const double k4 = 600.0; // units: 1/s
